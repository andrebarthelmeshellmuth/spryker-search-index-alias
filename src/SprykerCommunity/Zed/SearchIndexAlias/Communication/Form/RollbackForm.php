...
class RollbackForm extends AbstractType
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    public const FIELD_TARGET_INDEX_NAME = 'targetIndexName';
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add(static::FIELD_TARGET_INDEX_NAME, HiddenType::class, [
            'constraints' => [new NotBlank()],
        ]);
    ...
    {
        return 'search_index_alias_rollback';
    }
}
